...
| ACQ-GENERIC | Clear MP4/HLS/DASH and embedded-player discovery remain available | `923d8c9` | `test-media-observer.mjs`, `test-browser-audio-fallback.mjs` | M-14 | Simulated pass; real browser unverified |
