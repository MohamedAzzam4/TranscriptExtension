...
| ACQ-GENERIC | Clear MP4/HLS/DASH and embedded-player discovery remain available | `923d8c9`, versions `0.10.1`–`0.10.2` | `test-media-observer.mjs`, `test-network-media-observer.mjs`, `test-batch-lifecycle.mjs`, `test-browser-audio-fallback.mjs`, server HLS tests | M-14 | AniWorld user-run pass; AnimeKai HLS audio-rendition fix awaiting retest |
